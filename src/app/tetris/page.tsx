...
import { Record } from '@/components/tetris/Record';
import { TouchControls } from '@/components/tetris/TouchControls';
import { useTouchControls } from '@/hooks/useTouchControls';
import { SoundToggle } from '@/components/tetris/SoundToggle';
import { ThemeProvider } from '@/contexts/ThemeContext';
import { ThemeToggle } from '@/components/tetris/ThemeToggle';
import { KeyboardGuide } from '@/components/tetris/KeyboardGuide';
import { Statistics } from '@/components/tetris/Statistics';
import { Achievements } from '@/components/tetris/Achievements';
            ...
            >
              <div className="w-full h-full flex gap-[1vh] overflow-hidden">
                <div className="flex-[3] flex items-center justify-center overflow-hidden">
                  <Matrix state={state} particleSystem={particleSystem} />
                </div>
